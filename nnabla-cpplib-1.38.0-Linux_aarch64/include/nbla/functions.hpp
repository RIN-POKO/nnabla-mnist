...
NBLA_API vector<CgVariablePtr> erf(Context &ctx, CgVariablePtr x);
NBLA_API CgVariablePtr erf(CgVariablePtr x);
...
NBLA_API vector<CgVariablePtr> shape(Context &ctx, CgVariablePtr x, int start, int end);
NBLA_API CgVariablePtr shape(CgVariablePtr x, int start, int end);
...
NBLA_API vector<CgVariablePtr> trilu(Context &ctx, CgVariablePtr x, int k, bool upper);
NBLA_API CgVariablePtr trilu(CgVariablePtr x, int k, bool upper);
...
NBLA_API vector<CgVariablePtr> batch_cholesky(Context &ctx, CgVariablePtr x, bool upper);
NBLA_API CgVariablePtr batch_cholesky(CgVariablePtr x, bool upper);
...
NBLA_API vector<CgVariablePtr> nonzero(Context &ctx, CgVariablePtr x);
NBLA_API CgVariablePtr nonzero(CgVariablePtr x);
...
NBLA_API vector<CgVariablePtr> onnx_resize(Context &ctx, CgVariablePtr x, const vector<float> & roi, const vector<float> & scales, const vector<int> & sizes, const string & mode, const string & coordinate_transformation_mode, float cubic_coeff_a, int exclude_outside, float extrapolation_value, const string & nearest_mode);
NBLA_API CgVariablePtr onnx_resize(CgVariablePtr x, const vector<float> & roi, const vector<float> & scales, const vector<int> & sizes, const string & mode, const string & coordinate_transformation_mode, float cubic_coeff_a, int exclude_outside, float extrapolation_value, const string & nearest_mode);
...
NBLA_API vector<CgVariablePtr> top_k_data(Context &ctx, CgVariablePtr x, int k, bool abs, bool reduce, int base_axis, bool largest, bool with_index);
NBLA_API CgVariablePtr top_k_data(CgVariablePtr x, int k, bool abs, bool reduce, int base_axis, bool largest, bool with_index);
...
NBLA_API vector<CgVariablePtr> onnx_non_max_suppression(Context &ctx, CgVariablePtr boxes, CgVariablePtr scores, int center_point_box, int max_output_boxes_per_class, float iou_threshold, float score_threshold);
NBLA_API CgVariablePtr onnx_non_max_suppression(CgVariablePtr boxes, CgVariablePtr scores, int center_point_box, int max_output_boxes_per_class, float iou_threshold, float score_threshold);
...
NBLA_API vector<CgVariablePtr> unique(Context &ctx, CgVariablePtr x, bool flatten, int axis, bool sorted, bool with_index, bool with_inverse, bool with_counts);
NBLA_API CgVariablePtr unique(CgVariablePtr x, bool flatten, int axis, bool sorted, bool with_index, bool with_inverse, bool with_counts);

NBLA_API vector<CgVariablePtr> eye_like(Context &ctx, CgVariablePtr x, int k);
NBLA_API CgVariablePtr eye_like(CgVariablePtr x, int k);

NBLA_API vector<CgVariablePtr> mod2(Context &ctx, CgVariablePtr x0, CgVariablePtr x1, bool fmod);
NBLA_API CgVariablePtr mod2(CgVariablePtr x0, CgVariablePtr x1, bool fmod);

NBLA_API vector<CgVariablePtr> bit_shift(Context &ctx, CgVariablePtr x, CgVariablePtr shift, const string & direction);
NBLA_API CgVariablePtr bit_shift(CgVariablePtr x, CgVariablePtr shift, const string & direction);

NBLA_API vector<CgVariablePtr> einsum(Context &ctx, CgVariablePtr x, const string & equation);
NBLA_API CgVariablePtr einsum(CgVariablePtr x, const string & equation);
NBLA_API vector<CgVariablePtr> einsum(Context &ctx, vector<CgVariablePtr> x, const string & equation);
NBLA_API CgVariablePtr einsum(vector<CgVariablePtr> x, const string & equation);
